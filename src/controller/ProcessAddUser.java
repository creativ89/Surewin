...
public class ProcessAddUser extends HttpServlet {
	public void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.sendRedirect("User-Signup.jsp?errMsg=Date is in the wrong format.");
			return;
		}
		...
		udm.add(newUser);
		response.sendRedirect("User-Signin.jsp?errMsg=You have successfully created an account!");
		return;
	}
