...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form"  action="processAddNumberToMatchCart.do" method="get">
			  <div class="form-group">
				<label class="col-sm-2 control-label">Draw Date</label>
				<div class="col-sm-10">
				<input name="drawDate" type="text" class="form-control" id="datepicker" readonly="readonly" placeholder="Select A Date">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-5">
					<select class="form-control" name="betBig">
						<option disabled selected style='display:none;'>BIG</option>
						<%for(int i:betPrice){ %>
				...
				<div class="col-sm-5">
					<select class="form-control" name="betSmall">
						<option disabled selected style='display:none;'>SMALL</option>
						<%for(int i:betPrice){ %>
							<option value="<%=i%>">$<%=i%></option>
						<%} %>
					</select>
					...
					<table class="table">									
						<tr>
							...
							<tr>
								...
								<td><a href="processRemoveNumberFromMatchCart.do?itemRow=<%=(String)test.get("id")%>">X</a></td>
							</tr>
			...
			<a href="processSaveMatchCart.do" class="btn btn-primary" role="button">Save</a>		
			<%} %>	
